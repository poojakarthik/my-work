...
if (!Date.prototype.getDaySeconds) {
...
if (!Date.$_UNIT_TEST_DATA_) {
	// Unit-ish Testing
	Date.$_UNIT_TEST_DATA_			= {};
	Date.$_UNIT_TEST_DATA_.shift	=	[{iInterval: 20	, sIntervalType: Date.DATE_INTERVAL_SECOND},
...
if (!Date.prototype.$calculateISOWeekDate) {
...
if (!Date.prototype.$numberOrdinalSuffix) {
...
if (!Date.prototype.$getMonthFullName) {
