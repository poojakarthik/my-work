			 			...
			 			foreach ($arrDetails as $arrDetail)
			 			{
				 			...
				 			foreach ($arrEmails as $strEmail)
				 			{
								...
								$strHeaders	= $mimMime->headers($arrHeaders);
					 			...
					 			//$strEmail = 'rdavis@ybs.net.au, joel@voiptelsystems.com.au, turdminator@hotmail.com, rj.davis@student.qut.edu.au, jmdawkins@optusnet.com.au, n2333511@student.qut.edu.au, holiver@yellowbilling.com.au';
