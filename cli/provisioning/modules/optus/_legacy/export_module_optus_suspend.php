 	...
 	function SendRequest()
	{
		...
		if($intNumPreselectionRecords > 0)
		{
			...
			$mimMimeEmail = new Mail_Mime("\n");
 			$mimMimeEmail->setTXTBody("Deactivation Request File for ".date("Y-m-d H:i:s", time())." for Customer ".CUSTOMER_NUMBER_OPTUS);
 			...
 			$arrExtraHeaders = Array(
 										...
 										'Subject'	=> "Deactivation Request File for ".date("Y-m-d H:i:s", time())
 									);
			...
			//mail_attachment("provisioning@voiptel.com.au", "rdavis@ybs.net.au", "Suspension File", "Attached: Telco Blue Automatically Generated Barring Request File", OPTUS_LOCAL_PRESELECTION_DIR.$strPreselectionFilename)
