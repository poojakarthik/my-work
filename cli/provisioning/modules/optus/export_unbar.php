 ...
 * export_unbar
 *
 * Exports Optus UnBar File Requests
 *
 * Exports Optus UnBar File Requests
 *
 * @file		export_unbar.php
 * @language	PHP
 ...
 *
 * @package		provisioning
 * @class		ExportOptusUnBar
 */
 class ExportOptusUnBar extends ExportBase
 {
 	//------------------------------------------------------------------------//
	// Properties
	//------------------------------------------------------------------------//
	...
	public $intBaseFileType		= RESOURCE_TYPE_FILE_EXPORT__PROVISIONING_OPTUS_RESTORE;
	 ...
	 */
 	function __construct($intCarrier)
 	{
		...
		// Mandatory
 		...
 		$this->_arrModuleConfig['Subject']			['Default']		= 'Unbar Request File for <Function::DateTime> for <Config::OptusAccount>';
 		...
 		$this->_arrModuleConfig['EmailContent']		['Default']		= 'Unbar Request File for <Function::DateTime> for <Config::OptusAccount>';
