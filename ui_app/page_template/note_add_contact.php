...
//----------------------------------------------------------------------------//
// note_add_contact.php
//----------------------------------------------------------------------------//
/**
 * note_add_contact
 *
 * Page Template for the Add Note Contact popup window
 *
 * Page Template for the Add Note Contact popup window
...
// set the page title
$this->Page->SetName('Add Note');

// set the layout template for the page.
$this->Page->SetLayout('popup_layout');

// add the Html Objects to their respective columns
$this->Page->AddObject('NoteAdd', COLUMN_ONE, HTML_CONTEXT_CONTACT_NOTE);
