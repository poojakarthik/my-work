...
function VixenValidateAdjustmentClass()
{
	...
	this.SetChargeTypeData = function(objChargeTypeData)
	{
	...
	this.DeclareChargeType = function(objObject)
	{
		...
		// set Amount to be the default amount
		// How would I set DBO()->Charge->Amount from here?
		// How would I apply the appropriate output mask for the amount?
		strDefaultAmount = document.getElementById("ChargeType." + strChargeType).getAttribute('DefaultAmount');
