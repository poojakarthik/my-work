...
// Set the page title
$this->Page->SetName("Modify Advertisement Image");

//Sset the layout template for the page.
$this->Page->SetLayout('1Column');

// Add the Html Objects to their respective columns
$this->Page->AddObject('CustomerGroupChangeAdvertisement', COLUMN_ONE, HTML_CONTEXT_DEFAULT, "CustomerGroupNewContainerDiv");
