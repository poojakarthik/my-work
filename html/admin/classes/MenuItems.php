...
class MenuItems {
	...
	function TelemarketUploadProposed() {
		...
		return "javascript:JsAutoLoader.loadScript('javascript/telemarketing_proposedupload.js', function(){if (Flex.Telemarketing.ProposedUpload != undefined) Flex.Telemarketing.ProposedUpload.displayPopupUpload();});";
	}
