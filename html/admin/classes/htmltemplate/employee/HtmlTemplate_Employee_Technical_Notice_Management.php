...
class HtmlTemplate_Employee_Technical_Notice_Management extends FlexHtmlTemplate
{
	public function __construct($intContext=NULL, $strId=NULL, $mxdDataToRender=NULL)
	{
		parent::__construct($intContext, $strId, $mxdDataToRender);
		
		$this->LoadJavascript("employee_technical_notice");
	}
	...
	<caption>
		<div id='caption_bar' class='caption_bar'>
			...
			<div id='caption_options' class='caption_options'>
				<a onclick='FlexEmployeeTechnicalNotice.newMessage()'>New</a>
			</div>
		</div>
	</caption>
	<thead class='header'>
