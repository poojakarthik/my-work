<?php
class JSON_Handler_FollowUp_Category extends JSON_Handler implements JSON_Handler_Loggable {
	public function getDataSet($bCountOnly=false, $iLimit=0, $iOffset=0, $oFieldsToSort=null, $oFilter=null) {
		try {
			...
			$aSort = $oFieldsToSort ? get_object_vars($oFieldsToSort) : null;
			$aFilter = $oFilter ? get_object_vars($oFilter): null;
...
class JSON_Handler_FollowUp_Category_Exception extends Exception {/* No Changes */}
