...
class JSON_Handler_Employee_Technical_Notice extends JSON_Handler
{
...
<div id='PopupPageBody'>
	...
	<div style='padding-top:3px;height:auto:width:100%'>
		<div style='float:right'>
			<input type='button' id='EmployeeMessagePopup_SaveButton' name='EmployeeMessagePopup_SaveButton' value='Save' onclick='FlexEmployeeTechnicalNotice.saveNewMessage()' style='margin-left:3px'></input>
