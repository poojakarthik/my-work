...
class Application_Handler_Customer extends Application_Handler
{

	// The Customer Verification page
	public function Verification($subPath)
	{
		// Check user permissions
		AuthenticatedUser()->PermissionOrDie(PERMISSION_OPERATOR_VIEW);
		
		BreadCrumb()->Admin_Console();
		BreadCrumb()->SetCurrentPage("Customer Verification");
