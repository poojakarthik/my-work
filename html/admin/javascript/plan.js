...
({
	...
	setBrochure	: function(intRatePlanId, strRatePlanName, strCustomerGroup)
	{
		...
		var strHTML	= "\n" +
		"<form id='Plan_SetBrochure_Form' name='Plan_SetBrochure_Form' method='post' action='../admin/reflex.php/RatePlan/SetBrochure/' enctype='multipart/form-data' onsubmit='Flex.Plan._setBrochureSubmit(); return false;' >\n" +
	...
	setAuthScript	: function(intRatePlanId, strRatePlanName, strCustomerGroup)
	{
		...
		var strHTML	= "\n" +
		"<form id='Plan_SetAuthScript_Form' name='Plan_SetAuthScript_Form' method='post' action='../admin/reflex.php/RatePlan/SetAuthScript/' enctype='multipart/form-data' onsubmit='Flex.Plan._setAuthScriptSubmit(); return false;' >\n" +
