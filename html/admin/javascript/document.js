...
({
	...
	emailDocument	: function(intDocumentId, strDescription, arrEmailAddresses)
	{
		...
		"				<td valign='top'><input id='Document_Email_OtherAddress' type='text' size='40' />&nbsp;<img src='../admin/img/template/new.png' onclick='Flex.Document.emailAddAddress()' style='vertical-align: middle;' /></td>\n" +  
		"			</tr>\n" + 
		"		</tbody>\n" + 
		"	</table>\n" + 
		"</div>\n" + 
