...
({
	...
	emailDocument	: function(intDocumentId, strDescription, arrEmailAddresses)
	{
		...
		"				<td valign='top'><input id='Document_Email_OtherAddress' type='text' size='40' />&nbsp;<img src='../admin/img/template/new.png' onclick='Flex.Document.emailAddAddress()' style='vertical-align: text-top;' /></td>\n" +  
		"			</tr>\n" + 
		"		</tbody>\n" + 
		"	</table>\n" + 
		"</div>\n" + 
		...
		"				<td><textarea style='vertical-align: top;' rows='10' cols='46'></textarea></td>\n" +  
		"			</tr>\n" + 
		"		</tbody>\n" + 
		"	</table>\n" + 
		"</div>\n" + 
