var FlexEmployeeTechnicalNotice = {
	POPUP_ID		: "EmployeeTechnicalNotice",

	elmMessage		: null,
	strMessageTypeConstant	: 'EMPLOYEE_MESSAGE_TYPE_TECHNICAL',

	// Loads the popup, for the customer declared by intContact and intAccount
	newMessage : function()
	{
		jsonFunc = jQuery.json.jsonFunction(this.newMessageReturnHandler.bind(this), null, "Employee_Technical_Notice", "buildPopup");
	...
	newMessageReturnHandler : function(oResponse)
	{
		...
		{
			// Display the popup
			Vixen.Popup.Create(this.POPUP_ID, oResponse.PopupContent, "ExtraLarge", "centre", "modal", "Employee Technical Notice");
	...
	saveNewMessage : function(bolConfirmed)
	{
		if (!bolConfirmed)
		{
			...
			Vixen.Popup.Confirm("Are you sure you want to save this message?", function(){FlexEmployeeTechnicalNotice.saveNewMessage(true)});
			return;
		}
		else
		{
	...
	{
		jsonFunc = jQuery.json.jsonFunction(this.saveMessageReturnHandler.bind(this), null, "Employee_Technical_Notice", "save");
