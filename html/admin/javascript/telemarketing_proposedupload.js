...
({
	...
	_renderPopupUpload	: function(objResponse)
	{
		...
		// Generate Popup HTML
		var strHTML	= "\n" + 
		"<form id='Telemarketing_ProposedUpload_Form' name='Telemarketing_ProposedUpload_Form' method='post' action='../admin/reflex.php/Telemarketing/UploadProposedDiallingList/' enctype='multipart/form-data' onsubmit='return Flex.Telemarketing.ProposedUpload.submit()' >\n" + 
		...
		"					<td>Dealer:</td>\n" + 
		"					<td>\n" + 
		"						<select id='Telemarketing_ProposedUpload_Dealer' name='Telemarketing_ProposedUpload_Dealer' onchange='Flex.Telemarketing.ProposedUpload.updatePermittedVendors()'>\n" + 
		...
		"					<td>Vendor:</td>\n" + 
		"					<td>\n" + 
		"						<select id='Telemarketing_ProposedUpload_Vendor' name='Telemarketing_ProposedUpload_Vendor'>\n" + 
		"							<option value='' selected='selected'>[None]</option>\n" + 
		"						</select>\n" + 
		"					</td>\n" + 
		"				</tr>\n" + 
		...
		"					<td>File to wash:</td>\n" + 
		"					<td>\n" + 
		"						<input type='file' id='Telemarketing_ProposedUpload_File' name='Telemarketing_ProposedUpload_File' />\n" + 
		"					</td>\n" + 
		"				</tr>\n" + 
		"			</tbody>\n" + 
		"		</table>\n" + 
		...
		"		<input type='submit' class='normal-button' id='Telemarketing_ProposedUpload_Upload' value='Upload' style='margin-left:3px' /> \n" +
