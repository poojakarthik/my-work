...
({
	...
	submit			: function()
	{
		...
		$ID('Telemarketing_ProposedUpload_Submit').visible					= false;
		$ID('Telemarketing_ProposedUpload_Cancel').visible					= false;
		$ID('VixenPopupTopBarClose__Telemarketing_ProposedUpload').visible	= false;
