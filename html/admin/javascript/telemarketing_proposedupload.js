...
({
	...
	_renderPopupUpload	: function(objResponse)
	{
		...
		// Generate Popup HTML
		var strHTML	= "\n" + 
		"<form id='Telemarketing_ProposedUpload_Form' name='Telemarketing_ProposedUpload_Form' method='post' action='../admin/reflex.php/Telemarketing/UploadProposedDiallingList/' enctype='multipart/form-data' target='Telemarketing_ProposedUpload_Form_iframe'>\n" + 
