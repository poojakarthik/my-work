...
var Component_Operation_Profile_List = Class.create(
{
	initialize	: function(oContainerDiv)
	{
		...
		this.oPagination	= new Pagination(this._updateTable.bind(this), Component_Operation_Profile_List.MAX_RECORDS_PER_PAGE, this.oDataset);
		
		// Create the page HTML
		var sButtonPathBase	= '../admin/img/template/resultset_';
		this.oContentDiv 	= $T.div({class: 'component-operation-profile-list'},
											...
											$T.tr(
												$T.th({colspan: '11'},
													$T.button({class: 'icon-button'},
														$T.img({src: Component_Operation_Profile_List.ADD_IMAGE_SOURCE, alt: '', title: 'Add Permission Profile'}),
		...
		if (oData.id != null)
		{
			var	oTR	=	$T.tr(
							...
							$T.td({class: 'operation-profile-list-action'},
								$T.img({src: Component_Operation_Profile_List.EDIT_IMAGE_SOURCE, alt: 'Edit', title: 'Edit'})
							)
						);
...
Component_Operation_Profile_List.MAX_RECORDS_PER_PAGE	= 15;
Component_Operation_Profile_List.EDIT_IMAGE_SOURCE		= '../admin/img/template/group_key.png';
Component_Operation_Profile_List.ADD_IMAGE_SOURCE		= '../admin/img/template/new.png';
