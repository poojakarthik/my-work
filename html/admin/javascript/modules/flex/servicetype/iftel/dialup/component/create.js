...
var self = new Class({
	...
	construct: function () {
		...
		this.NODE.addClassName('flex-servicetype-iftel-dialup-create');
	},

	_buildUI: function () {
		var latestDate = new Date();
		this.NODE = H.div(
			H.label({class: 'flex-servicetype-iftel-dialup-create-email'},
				H.span({class: 'flex-servicetype-iftel-dialup-create-email-label'}, 'Email Address'),
