...
var Component_FollowUp_List_All = Class.create(
{
	...
	_createTableRow	: function(oFollowUp)
	{
		...
		{
			var	oTR	=	$T.tr(
							$T.td(Component_FollowUp_List_All._getTypeString(oFollowUp.followup_type_id)),		
							Component_FollowUp_List_All.getFollowUpDescriptionTD(oFollowUp.followup_type_id, oFollowUp.details),
							$T.td(oFollowUp.summary),
							$T.td(Component_FollowUp_List_All.formatDate(oFollowUp.created_datetime)),				
							$T.td(oFollowUp.assigned_employee_label),
							$T.td(Component_FollowUp_List_All.formatDate(oFollowUp.due_datetime)),
							$T.td(Component_FollowUp_List_All.formatDate(oFollowUp.modified_datetime)),
...
// Helper functions
Component_FollowUp_List_All._getTypeString	= function(iType)
{
...
Component_FollowUp_List_All.formatDate	= function(sMySQLDate)
{
