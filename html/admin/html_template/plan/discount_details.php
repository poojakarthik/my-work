		...
		if (DBL()->RecordType->RecordCount() > 0)
		{
			foreach (DBL()->RecordType as $dboRecordType)
			{
				...
				echo	"<tr value='{$dboRecordType->Id->Value}'>\n" .
						...
						"	<td>".((array_key_exists($dboRecordType->Id->Value, $aRecordTypeDiscountMap)) ? htmlspecialchars($aRecordTypeDiscountMap[$dboRecordType->Id->Value]->name->Value) : "<span style='font-style: italic; opacity: 0.5;'>[ No Discount ]</span>")."</td>\n" .
						"</tr>\n";
			}
		}
		else
