...
define("MODULE_SERVICE_TYPE"			, "MODULE_SERVICE_TYPE");//, 0x400);
...
define("MODULE_SERVICE_ADDRESS"         , "MODULE_SERVICE_ADDRESS"); //, 0x1000000000);
define("MODULE_INBOUND"         		, "MODULE_INBOUND"); //, 0x2000000000);
