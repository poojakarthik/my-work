 ...
 */
 ...
 class HtmlTemplateCustomerSupportConfirmed extends HtmlTemplate
{
	//------------------------------------------------------------------------//
	// _intContext
	//------------------------------------------------------------------------//
	...
	function Render()
	{
		...
		<TR>
			<TD>Thank you for taking the time to submit a request.<br/><br/>Your request has been received.<br/><br/></TD>
		</TR>
		</TABLE>
		</div>";
