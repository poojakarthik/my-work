...
//$this->Page->AddObject('SmallSeparator', COLUMN_ONE, HTML_CONTEXT_DEFAULT);
$this->Page->AddObject('CustomerGroupLetterTemplates', COLUMN_ONE, HTML_CONTEXT_DEFAULT, "LetterTemplatesContainerDiv");
