...
Object.extend(Reflex_Popup, {
	...
	hide : function (popup) {
		...
		} else { // Otherwise we can re-append the second to last element (the previous popup in the stack)
	...
	factory : function (mContent, oConfig) {
		...
		if (oConfig.sExtraClass) {
			oPopup.setExtraClass(oConfig.sExtraClass);
		}
...
Object.extend(Reflex_Popup.prototype, {
	...
	setExtraClass : function (sExtraClass) {
		if (this.sExtraClass) {
			this.container.removeClassName(this.sExtraClass);
		}
		this.sExtraClass = sExtraClass;
		this.container.addClassName(this.sExtraClass);
		return this;
	},
