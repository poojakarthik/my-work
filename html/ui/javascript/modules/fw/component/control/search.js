...
var self = new Class({
	...
	construct : function() {
		...
		this.NODE.addClassName('fw-control-search');
	},
	
	_buildUI : function() {
		this._super();
		this._oInput	= $D.input({type: 'search'});
		this._oView 	= $D.span({'class': 'fw-control-search-view'});
		...
		this._oInput.observe('search', this._valueChange.bind(this));
	},
