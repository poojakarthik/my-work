var Control_Tree_Grid_Node_Data	= Class.create(/* extends */ Control_Tree_Grid_Node, 
{
	initialize	: function($super, oContent, sDataType)
	{
		...
		this._oElement.oExpandIcon.domElement.title	= '';
		...
		this._oElement.oRowIcon.domElement.title	= '';
	...
	_updateExpandIcon	: function()
	{
		...
		if (this._aChildren.length)
		{
			...
			this._oElement.oExpandIcon.domElement.title	= (this.isExpanded()) ? 'Collapse' : 'Expand';
	...
	_updateNodeIcon	: function()
	{
		if (this.getDataType() && this.getTreeGrid() && this.getTreeGrid().oDataTypes[this.getDataType()] && this.getTreeGrid().oDataTypes[this.getDataType()].sIconSource)
		{
			...
			this._oElement.oRowIcon.domElement.title			= this.getTreeGrid().oDataTypes[this.getDataType()].sDescription;
		}
		else
		{
