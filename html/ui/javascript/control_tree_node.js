...
({
	...
	setExpanded	: function(bExpanded, bAnimate)
	{
		...
		if (this.bExpanded)
		{
			...
			this.oSlideFX	= new Reflex_FX_Reveal(this.oChildrenList, 'top', 'slide', false, true, 1.0, 'ease');
		}
		else
		{
			...
			this.oSlideFX	= new Reflex_FX_Reveal(this.oChildrenList, 'top', 'slide', true, true, 1.0, 'ease');
		}
		this.oSlideFX.start();
		if (!bAnimate)
		{
