...
Reflex_FX_Reveal	= Class.create(/* extends */Reflex_FX,
{
	...
	_destruct	: function($super)
	{
		...
		this.oElement.style.height				= (fPercentComplete < 1.0 && !this.bReverse) ? this.oElement.style.height	: null;
		this.oElement.style.width				= (fPercentComplete < 1.0 && !this.bReverse) ? this.oElement.style.width	: null;
