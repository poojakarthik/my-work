<?php
/**
 * Telemarketing_FNN_Withheld_Reason
 *
 * This is an example of a class that extends ORM_Enumerated
 *
 * @class	Telemarketing_FNN_Withheld_Reason
 */
class Telemarketing_FNN_Withheld_Reason extends ORM_Enumerated
{	
	protected 			$_strTableName			= "telemarketing_fnn_withheld_reason";
	protected static	$_strStaticTableName	= "telemarketing_fnn_withheld_reason";
