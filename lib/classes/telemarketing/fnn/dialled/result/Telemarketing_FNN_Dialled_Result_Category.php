<?php
/**
 * Telemarketing_FNN_Dialled_Result_Category
 *
 * Objectively Models the telemarketing_fnn_dialled_result_category Table (as an enumeration)
 *
 * @class	Telemarketing_FNN_Dialled_Result_Category
 */
class Telemarketing_FNN_Dialled_Result_Category extends ORM_Enumerated
{	
	protected 			$_strTableName			= "telemarketing_fnn_dialled_result_category";
	protected static	$_strStaticTableName	= "telemarketing_fnn_dialled_result_category";
