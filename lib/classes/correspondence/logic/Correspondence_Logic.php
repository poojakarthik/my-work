...
class Correspondence_Logic
{
	...
	public function save()
	{
		...
		{
			if ($oField->correspondence_id === null)
			{
				$oField->correspondence_id	= $this->id;
			}
			
			if ($oField->correspondence_template_column_id === null)
			{
	...
	public static function getForRun($oRun)
	{
		...
		{
			if (!array_key_exists($oORM->correspondence_delivery_method_id, $aCorrespondence))
			{
				$aCorrespondence[$oORM->correspondence_delivery_method_id]	= array();
			}
			$aCorrespondence[$oORM->correspondence_delivery_method_id][]	= new Correspondence_Logic($oORM, $oRun);
		}
