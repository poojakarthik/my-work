 ...
 */
class Collection_Restriction extends ORM_Cached
{
	protected 			$_strTableName			= "collection_restriction";
	protected static	$_strStaticTableName	= "collection_restriction";
