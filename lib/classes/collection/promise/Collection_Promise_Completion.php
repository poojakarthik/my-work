 ...
 *
 * @class	Collection_Promise_Completion
 */
class Collection_Promise_Completion extends ORM_Cached
{
	protected 			$_strTableName			= "collection_promise_completion";
	protected static	$_strStaticTableName	= "collection_promise_completion";
