<?php
/**
 * Collection_Promise_Instalment
 *
 * This is an example of a class that extends ORM_Cached
 *
 * @class	Collection_Promise_Instalment
 */
class Collection_Promise_Instalment extends ORM_Cached
{
	protected 			$_strTableName			= "collection_promise_instalment";
	protected static	$_strStaticTableName	= "collection_promise_instalment";
