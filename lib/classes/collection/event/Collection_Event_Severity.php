<?php
/**
 * Collection_Event_Severity
 *
 * This is an example of a class that extends ORM_Cached
 *
 * @class	Collection_Event_Severity
 */
class Collection_Event_Severity extends ORM_Cached
{
	protected 			$_strTableName			= "collection_event_severity";
	protected static	$_strStaticTableName	= "collection_event_severity";
