<?php
/**
 * Collection_Event_Report
 *
 * This is an example of a class that extends ORM_Cached
 *
 * @class	Collection_Event_Report
 */
class Collection_Event_Report_Output extends ORM_Cached
{
	protected 			$_strTableName			= "collection_event_report_output";
	protected static	$_strStaticTableName	= "collection_event_report_output";
