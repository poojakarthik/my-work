<?php
/**
 * Collection_Event_Charge
 *
 * This is an example of a class that extends ORM_Cached
 *
 * @class	Collection_Event_Charge
 */
class Collection_Event_Charge extends ORM_Cached
{
	protected 			$_strTableName			= "collection_event_charge";
	protected static	$_strStaticTableName	= "collection_event_charge";
