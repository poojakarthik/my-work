 ...
 */
class Collection_Event_Type_Implementation extends ORM_Cached
{
	protected 			$_strTableName			= "collection_event_type_implementation";
	protected static	$_strStaticTableName	= "collection_event_type_implementation";
