 ...
 */
class Collection_Event_Action extends ORM_Cached
{
	protected 			$_strTableName			= "collection_event_action";
	protected static	$_strStaticTableName	= "collection_event_action";
