<?php
/**
 * Collection_Event_Action
 *
 * This is an example of a class that extends ORM_Cached
 *
 * @class	Collection_Event_Action
 */
class Collection_Event_Correspondence extends ORM_Cached
{
	protected 			$_strTableName			= "collection_event_correspondence";
	protected static	$_strStaticTableName	= "collection_event_correspondence";
