 ...
 */
class Collection_Event_Report extends ORM_Cached
{
	protected 			$_strTableName			= "collection_event_report";
	protected static	$_strStaticTableName	= "collection_event_report";
