 ...
 */
class Collection_Suspension_Reason extends ORM_Cached
{
	protected 			$_strTableName			= "collection_suspension_reason";
	protected static	$_strStaticTableName	= "collection_suspension_reason";
