<?php
/**
 * Resource_Type_File_Export_Payment_SecurePay
 *
 * @class	Resource_Type_File_Export_Payment_SecurePay
 */
class Resource_Type_File_Export_Payment_SecurePay extends Resource_Type_File_Export_Payment
{
