...
class Logic_Collection_BatchProcess_Report
{
	...
	{
		$oEmail = Correspondence_Email::getForEmailNotificationSystemName(self::EMAIL_NOTIFICATION);
		...
		{
			$oEmail->addTextHeader(4, "Please note that the Accounts Collections Process is not eligible to run today, so no new events were scheduled/completed.");
		}
		$sMessage;
