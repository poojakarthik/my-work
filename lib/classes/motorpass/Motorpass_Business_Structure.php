<?php
/**
 * Motorpass_Business_Structure
 *
 * This is an example of a class that extends ORM_Enumerated
 *
 * @class	Motorpass_Business_Structure
 */
class Motorpass_Business_Structure extends ORM_Enumerated
{
	protected 			$_strTableName			= "motorpass_business_structure";
	protected static	$_strStaticTableName	= "motorpass_business_structure";
	
	public function getFullCode()
	{
		return str_pad($oMotorpassBusinessStructure->code_numeric, 2, '0', STR_PAD_LEFT).': '.$oMotorpassBusinessStructure->name;
	}
