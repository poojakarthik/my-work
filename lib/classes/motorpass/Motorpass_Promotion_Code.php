<?php
/**
 * Motorpass_Promotion_Code
 *
 * This is an example of a class that extends ORM_Cached
 *
 * @class	Motorpass_Promotion_Code
 */
class Motorpass_Promotion_Code extends ORM_Cached
{
	protected 			$_strTableName			= "motorpass_promotion_code";
	protected static	$_strStaticTableName	= "motorpass_promotion_code";
