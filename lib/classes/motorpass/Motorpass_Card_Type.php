 ...
 * Motorpass_Card_Type
 *
 * Models records from the motorpass_card_type Table
 *
 * @class	Motorpass_Card_Type
 */
class Motorpass_Card_Type extends ORM_Enumerated
{
	protected 			$_strTableName			= "motorpass_card_type";
	protected static	$_strStaticTableName	= "motorpass_card_type";
