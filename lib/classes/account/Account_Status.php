 ...
 * Account_Status
 *
 * Models the Account_Status table
 *
 * @class	Account_Status
 */
class Account_Status extends ORM_Enumerated
{	
	protected 			$_strTableName			= "account_status";
	protected static	$_strStaticTableName	= "account_status";
