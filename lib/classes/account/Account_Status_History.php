 ...
 */
class Account_Status_History extends ORM_Cached
{
	protected 			$_strTableName			= "account_status_history";
	protected static	$_strStaticTableName	= "account_status_history";
