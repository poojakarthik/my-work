 ...
 * Carrier_Module_Type
 *
 * Represents a Record in the carrier_module_type table
 *
 * @class	Carrier_Module_Type
 */
class Carrier_Module_Type extends ORM_Cached
{
	protected 			$_strTableName			= "carrier_module_type";
	protected static	$_strStaticTableName	= "carrier_module_type";
