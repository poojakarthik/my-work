 ...
 *
 * @class	Payment_Request_Invoice
 */
class Payment_Request_Invoice extends ORM_Cached
{
	protected 			$_strTableName			= "payment_request_invoice";
	protected static	$_strStaticTableName	= "payment_request_invoice";
