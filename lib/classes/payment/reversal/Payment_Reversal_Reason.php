 ...
 *
 * @class	Payment_Reversal_Reason
 */
class Payment_Reversal_Reason extends ORM_Cached
{
	protected 			$_strTableName			= "payment_reversal_reason";
	protected static	$_strStaticTableName	= "payment_reversal_reason";
