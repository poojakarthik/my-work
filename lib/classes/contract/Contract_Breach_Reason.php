<?php
/**
 * Contract_Breach_Reason
 *
 * This is an example of a class that extends ORM_Enumerated
 *
 * @class	Contract_Breach_Reason
 */
class Contract_Breach_Reason extends ORM_Enumerated
{
	protected 			$_strTableName			= "contract_breach_reason";
	protected static	$_strStaticTableName	= "contract_breach_reason";
