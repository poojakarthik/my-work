 ...
 * Direct_Debit
 *
 * Models a record of the direct_debit table
 *
 * @class	Direct_Debit
 */
class Direct_Debit extends ORM
{
	protected			$_strTableName				= "direct_debit";
	protected static	$_strStaticTableName		= "direct_debit";
