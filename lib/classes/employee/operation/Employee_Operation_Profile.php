<?php
/**
 * Employee_Operation_Profile
 *
 * Models a record of the employee_operation_profile table
 *
 * Models a record of the employee_operation_profile table
 *
 * @class	Employee_Operation_Profile
 */
class Employee_Operation_Profile extends ORM_Cached
{	
	protected 			$_strTableName			= "employee_operation_profile";
	protected static	$_strStaticTableName	= "employee_operation_profile";
	...
	public static function getForEmployeeId($iEmployeeId)
	{
		...
		while ($aEmployeeOperationProfile = $oSelect->Fetch())
		{
			$aResult[$aEmployeeOperationProfile['id']]	= new self($aEmployeeOperationProfile);
		}
