 ...
 *
 * cdr_call_type_translation Table
 *
 * @class	CDR_Call_Type_Translation
 */
class CDR_Call_Type_Translation extends ORM_Cached
{
	protected 			$_strTableName			= "cdr_call_type_translation";
	protected static	$_strStaticTableName	= "cdr_call_type_translation";
