 ...
 *
 * @class	FollowUp_Modify_Reason
 */
class FollowUp_Modify_Reason extends ORM_Cached
{
	protected 			$_strTableName			= "followup_modify_reason";
	protected static	$_strStaticTableName	= "followup_modify_reason";
