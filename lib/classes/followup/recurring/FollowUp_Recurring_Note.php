<?php
/**
 * FollowUp_Recurring_Note
 *
 * This is an example of a class that extends ORM_Cached
 *
 * @class	FollowUp_Recurring_Note
 */
class FollowUp_Recurring_Note extends ORM_Cached
{
	protected 			$_strTableName			= "followup_recurring_note";
	protected static	$_strStaticTableName	= "followup_recurring_note";
	...
	public static function getFollowUpRecurringsForNote($iNoteId)
	{
		$aFollowUps	= array();
