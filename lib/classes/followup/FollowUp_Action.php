 ...
 *
 * @class	FollowUp_Action
 */
class FollowUp_Action extends ORM_Cached
{
	protected 			$_strTableName			= "followup_action";
	protected static	$_strStaticTableName	= "followup_action";
		...
		else
		{
			switch ($strStatement)
			{
				...
				case 'selByFollowUpId':
					...
					break;
				case 'selByActionId':
					$arrPreparedStatements[$strStatement]	= new StatementSelect(self::$_strStaticTableName, "*", "action_id = <action_id>");
					break;
