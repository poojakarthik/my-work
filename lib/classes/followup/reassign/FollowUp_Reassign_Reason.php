 ...
 *
 * @class	FollowUp_Reassign_Reason
 */
class FollowUp_Reassign_Reason extends ORM_Cached
{
	protected 			$_strTableName			= "followup_reassign_reason";
	protected static	$_strStaticTableName	= "followup_reassign_reason";
