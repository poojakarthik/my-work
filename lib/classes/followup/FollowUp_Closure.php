 ...
 *
 * @class	FollowUp_Closure
 */
class FollowUp_Closure extends ORM_Cached
{
	protected 			$_strTableName			= "followup_closure";
	protected static	$_strStaticTableName	= "followup_closure";
