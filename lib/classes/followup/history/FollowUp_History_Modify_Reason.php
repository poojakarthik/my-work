<?php
/**
 * FollowUp_History_Modify_Reason
 *
 * This is an example of a class that extends ORM_Cached
 *
 * @class	FollowUp_History_Modify_Reason
 */
class FollowUp_History_Modify_Reason extends ORM_Cached
{
	protected 			$_strTableName			= "followup_history_modify_reason";
	protected static	$_strStaticTableName	= "followup_history_modify_reason";
