 ...
 * Destination_Context
 *
 * destination_context Table
 *
 * @class	Destination_Context
 */
class Destination_Context extends ORM_Enumerated
{
	protected 			$_strTableName			= "destination_context";
	protected static	$_strStaticTableName	= "destination_context";
