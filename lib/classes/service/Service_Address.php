 ...
 * Service_Address
 *
 * Models a record of the ServiceAddress table
 *
 * @class	Service_Address
 */
class Service_Address extends ORM
{
	protected			$_strTableName				= "ServiceAddress";
	protected static	$_strStaticTableName		= "ServiceAddress";
