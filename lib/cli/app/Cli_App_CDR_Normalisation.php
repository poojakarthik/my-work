<?php
//----------------------------------------------------------------------------//
// Cli_App_CDR_Normalisation
//----------------------------------------------------------------------------//
/**
 * Cli_App_CDR_Normalisation
 *
 * CDR Normalisation CLI Application
 *
 * CDR Normalisation CLI Application
 *
 * @class	Cli_App_CDR_Normalisation
 * @parent	Cli
 */
class Cli_App_CDR_Normalisation extends Cli
{
	...
	function run()
	{
		try
		{
			...
			{
				case 'IMPORT':
					// Imports CDRs from Files to the CDR table
					// TODO
					throw new Exception("IMPORT is not supported yet!");
					break;
					
				case 'NORMALISE':
					// Converts CDRs from their raw format to Flex's native format
					throw new Exception("NORMALISE is not supported yet!");
					break;
