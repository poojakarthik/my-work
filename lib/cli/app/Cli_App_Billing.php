...
class Cli_App_Billing extends Cli
{
	...
	private function _generate()
	{
		...
		$selInvoiceRunSchedule	= new StatementSelect("invoice_run_schedule", "*", "customer_group_id = <customer_group_id> AND '{$strDatetime}' = SUBDATE(<InvoiceDate>, INTERVAL invoice_day_offset DAY)");
