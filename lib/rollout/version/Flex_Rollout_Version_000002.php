...
class Flex_Rollout_Version_000002 extends Flex_Rollout_Version
{
	public function rollout()
	{
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception(__CLASS__ . " Failed to update the ClosedOn value of the Service table, for services with time component of ClosedOn == \"00:00:00\". " . mysqli_errno() . '::' . mysqli_error());
		}
