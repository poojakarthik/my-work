...
class Flex_Rollout_Version_000276 extends Flex_Rollout_Version {
	...
	public function rollout() {
		$aOperations = array(
			array(
				'sDescription' => "Add resource_type for Utilibill Payment Allocation Detail Normalisation",
				'sAlterSQL' => "
					INSERT INTO resource_type
						(name, description, const_name, resource_type_nature)
					VALUES
						(
							'Utilibill Payment Allocation Detail File',
							'Utilibill Payment Allocation Detail File',
							'RESOURCE_TYPE_FILE_IMPORT_PAYMENT_UTILIBILL_PAYMENTALLOCATIONDETAIL',
