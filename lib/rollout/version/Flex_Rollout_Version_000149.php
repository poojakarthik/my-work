 ...
 * This version: -
 *
 *	1:	Add Plan Brochure/Sripts, Interim/Final Invoice, and Telemarketing Flex Modules
 */
...
class Flex_Rollout_Version_000149 extends Flex_Rollout_Version
{
	...
	public function rollout()
	{
		...
		{
			throw new Exception(__CLASS__ . ' Failed to add the Plan Brochure/Sripts, Interim/Final Invoice, Telemarketing Flex Modules. ' . $result->getMessage() . " (DB Error: " . $result->getUserInfo() . ")");
		}
		$this->rollbackSQL[] =	"DELETE FROM flex_module " .
								"WHERE const_name IN ('FLEX_MODULE_PLAN_BROCHURE', 'FLEX_MODULE_PLAN_AUTH_SCRIPT', 'FLEX_MODULE_INVOICE_INTERIM', 'FLEX_MODULE_INVOICE_FINAL', 'FLEX_MODULE_TELEMARKETING');";
	}
