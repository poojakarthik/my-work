...
class Flex_Rollout_Version_000012 extends Flex_Rollout_Version
{
	...
	public function rollout()
	{
		...
		{
			throw new Exception_Database(__CLASS__ . ' Failed to add name and const_name columns to active_status table. ' . $qryQuery->Error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception_Database(__CLASS__ . ' Failed to add const_name columns to credit_control_status table. ' . $qryQuery->Error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception_Database(__CLASS__ . ' Failed to populate name and const_name columns to credit_control_status table. ' . $qryQuery->Error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception_Database(__CLASS__ . ' Failed to add const_name columns to automatic_invoice_action table. ' . $qryQuery->Error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception_Database(__CLASS__ . ' Failed to populate name and const_name columns to automatic_invoice_action table. ' . $qryQuery->Error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception_Database(__CLASS__ . ' Failed to add const_name columns to automatic_barring_status table. ' . $qryQuery->Error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception_Database(__CLASS__ . ' Failed to populate name and const_name columns to automatic_barring_status table. ' . $qryQuery->Error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception_Database(__CLASS__ . ' Failed to alter payment_terms table. ' . $qryQuery->Error());
		}
