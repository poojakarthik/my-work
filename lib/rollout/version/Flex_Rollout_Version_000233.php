 ...
 * This version: -
 *
 *	1:	Add the AAPT COCE CDR File Format Resource Type
 *
 */
...
class Flex_Rollout_Version_000233 extends Flex_Rollout_Version
{
	...
	public function rollout()
	{
		...
		elseif ($oResult->numRows())
		{
			...
			$this->outputMessage("Skipping ".self::getRolloutVersionNumber(__CLASS__).": AAPT COCE File already exists as a Resource Type...\n");
			return;
		}
