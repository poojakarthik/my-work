...
class Flex_Rollout_Version_000143 extends Flex_Rollout_Version
{
	...
	public function rollout()
	{
		...
		$strSQL =	"ALTER TABLE AccountLetterLog " .
					...
					"CHANGE Id			id							BIGINT(20)	NOT NULL	UNSIGNED	AUTO_INCREMENT	COMMENT 'Unique Identifier', " .
					"CHANGE Account		account_id					BIGINT(20)	NOT NULL	UNSIGNED					COMMENT '(FK) Account this log entry belongs to', " .
					"CHANGE Invoice		invoice_id					BIGINT(20)	NULL		UNSIGNED					COMMENT '(FK) Invoice this log relates to', " .
					"CHANGE LetterType	document_template_type_id	BIGINT(20)	NOT NULL	UNSIGNED					COMMENT '(FK) Document Template Type this log refers to', " .
		...
		$this->rollbackSQL[] =	"ALTER TABLE account_letter_log " .
								...
								"CHANGE id							Id			BIGINT(20)	NOT NULL	UNSIGNED	AUTO_INCREMENT	COMMENT 'Unique Identifier', " .
								"CHANGE account_id					Account		BIGINT(20)	NOT NULL	UNSIGNED					COMMENT '(FK) Account this log entry belongs to', " .
								"CHANGE invoice_id					Invoice		BIGINT(20)	NULL		UNSIGNED					COMMENT '(FK) Invoice this log relates to', " .
								"CHANGE document_template_type_id	LetterType	BIGINT(20)	NOT NULL	UNSIGNED					COMMENT '(FK) Document Template Type this log refers to', " .
		...
		$strSQL =	"ALTER TABLE DestinationTranslation " .
					...
					"CHANGE Id			id				BIGINT(20)		NOT NULL	UNSIGNED	AUTO_INCREMENT	COMMENT 'Unique Identifier', " .
					"CHANGE Code		code			BIGINT(20)		NOT NULL	UNSIGNED					COMMENT 'Flex Call Type Code', " .
		...
		$strSQL =	"ALTER TABLE DocumentResourceTypeFileType " .
					...
					"CHANGE Id				id							BIGINT(20)	NOT NULL	UNSIGNED	AUTO_INCREMENT	COMMENT 'Unique Identifier', " .
					"CHANGE ResourceType	document_resource_type_id	BIGINT(20)	NOT NULL	UNSIGNED					COMMENT '(FK) Document Resource Type', " .
					"CHANGE FileType		file_type_id				BIGINT(20)	NOT NULL	UNSIGNED					COMMENT '(FK) File Type', " .
					"\n" .
		...
		$this->rollbackSQL[] =	"ALTER TABLE document_resource_type_file_type " .
								...
								"CHANGE id							Id				BIGINT(20)	NOT NULL	UNSIGNED	AUTO_INCREMENT	COMMENT 'Unique Identifier', " .
								"CHANGE document_resource_type_id	ResourceType	BIGINT(20)	NOT NULL	UNSIGNED					COMMENT '(FK) Document Resource Type', " .
								"CHANGE file_type_id				FileType		BIGINT(20)	NOT NULL	UNSIGNED					COMMENT '(FK) File Type';";
