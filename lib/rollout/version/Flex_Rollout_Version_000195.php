...
class Flex_Rollout_Version_000195 extends Flex_Rollout_Version
{
	...
	public function rollout()
	{
		...
		$strSQL = "	ALTER TABLE			telemarketing_fnn_dialled_result
					...
					ADD		CONSTRAINT	telemarketing_fnn_dialled_result_fnn_dialled_result_category_id	FOREIGN KEY(telemarketing_fnn_dialled_result_category_id)	REFERENCES telemarketing_fnn_dialled_result_category(id)	ON UPDATE CASCADE	ON DELETE RESTRICT;";
		$result = $dbAdmin->query($strSQL);
		if (PEAR::isError($result))
		{
		...
		$this->rollbackSQL[] =	"	ALTER TABLE			telemarketing_fnn_dialled_result
									DROP	CONSTRAINT	telemarketing_fnn_dialled_result_fnn_dialled_result_category_id,
