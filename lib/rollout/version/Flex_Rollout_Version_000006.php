...
class Flex_Rollout_Version_000006 extends Flex_Rollout_Version
{
	...
	public function rollout()
	{
		...
		{
			throw new Exception(__CLASS__ . ' Failed to account_status table. ' . mysqli_errno() . '::' . mysqli_error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception(__CLASS__ . ' Failed to create credit_control_status table. ' . mysqli_errno() . '::' . mysqli_error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception(__CLASS__ . ' Failed to alter "payment_terms" table (1). ' . mysqli_errno() . '::' . mysqli_error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception(__CLASS__ . ' Failed to create automatic_invoice_action table. ' . mysqli_errno() . '::' . mysqli_error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception(__CLASS__ . ' Failed to create automatic_barring_status table. ' . mysqli_errno() . '::' . mysqli_error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception(__CLASS__ . ' Failed to create automatic_invoice_action_history table. ' . mysqli_errno() . '::' . mysqli_error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception(__CLASS__ . ' Failed to create automatic_barring_status_history table. ' . mysqli_errno() . '::' . mysqli_error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception(__CLASS__ . ' Failed to create credit_control_status_history table. ' . mysqli_errno() . '::' . mysqli_error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception(__CLASS__ . ' Failed to create account_status_history table. ' . mysqli_errno() . '::' . mysqli_error());
		}
		...
		if (!$qryQuery->Execute($strSQL))
		{
			throw new Exception(__CLASS__ . ' Failed to alter InvoiceRun table. ' . mysqli_errno() . '::' . mysqli_error());
		}
		...
		if (!$result)
		{
			throw new Exception(__CLASS__ . ' Failed to update InvoiceRun table. ' . mysqli_errno() . '::' . mysqli_error());
		}
