...
class Flex_Pdf_Template_Wrapped_Header extends Flex_Pdf_Template_Div 
{
	...
	function displayForSection($bolFirstSection, $bolFirstPage)
	{
		$section = $bolFirstSection ? ($bolFirstPage ? self::FIRST_SECTION_FIRST_PAGE : self::FIRST_SECTION_OTHER_PAGE) : self::NON_FIRST_SECTION_ANY_PAGE;
