...
class Flex_Pdf_Template_Wrapped_Footer extends Flex_Pdf_Template_Div 
{
	...
	function displayForSection($bolLastSection, $bolLastPage)
	{
		$section = $bolLastSection ? ($bolLastPage ? self::LAST_SECTION_LAST_PAGE : self::LAST_SECTION_OTHER_PAGE) : self::NON_LAST_SECTION_ANY_PAGE;
