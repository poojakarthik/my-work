 	...
 	function SendRequest()
	{
		...
		if($intNumPreselectionRecords > 0)
		{
			...
			$mimMimeEmail = new Mail_Mime("\n");
 			$mimMimeEmail->setTXTBody("Restoration Request File for ".date("Y-m-d", time())." for Customer ".CUSTOMER_NUMBER_OPTUS);
 			...
 			$arrExtraHeaders = Array(
 										...
 										'Subject'	=> "Restoration Request File for ".date("Y-m-d", time())
 									);
			...
			//mail_attachment("provisioning@voiptel.com.au", "rich@voiptelsystems.com.au", "Restoration File", "Attached: Telco Blue Automatically Generated Barring Request File", OPTUS_LOCAL_PRESELECTION_DIR.$strPreselectionFilename)
