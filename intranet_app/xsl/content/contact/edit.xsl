				...
				<div class="MsgError">
					<xsl:choose>
						...
						<xsl:when test="/Response/Error = 'FirstName'">
							You must enter a First Name for the Contact you are editing.
						</xsl:when>
						<xsl:when test="/Response/Error = 'LastName'">
							You must enter a Last Name for the Contact you are editing.
						</xsl:when>
						<xsl:when test="/Response/Error = 'DOB'">
							You must enter a valid Date of Birth for the Contact you are editing.
						</xsl:when>
						<xsl:when test="/Response/Error = 'Email'">
							You must enter an Email Address for the Contact you are editing.
						</xsl:when>
						<xsl:when test="/Response/Error = 'Phones Empty'">
							You must enter a Contact Number for the Contact you are editing.
						</xsl:when>
						<xsl:when test="/Response/Error = 'UserName Empty'">
							You must enter a Username for the Contact you are editing.
						</xsl:when>
