						...
						<tr>
							...
							<td>
								<input type="text" name="FirstName" class="input-string">
									<xsl:attribute name="value">
										<xsl:text></xsl:text>
										<xsl:value-of select="/Response/Employee/FirstName" />
									</xsl:attribute>
								</input>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" name="LastName" class="input-string">
									<xsl:attribute name="value">
										<xsl:text></xsl:text>
										<xsl:value-of select="/Response/Employee/LastName" />
									</xsl:attribute>
								</input>
							</td>
						</tr>
				...
				<div class="Filter-Form-Content">
					...
					<table border="0" cellpadding="5" cellspacing="0">
						<tr>
							...
							<td>
								<input type="text" name="UserName" class="input-string">
									<xsl:attribute name="value">
										<xsl:text></xsl:text>
										<xsl:value-of select="/Response/Employee/UserName" />
									</xsl:attribute>
								</input>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="password" name="New-PassWord" class="input-string" />
							</td>
						</tr>
						<tr>
							<th class="JustifiedWidth">
							...
							<td>
								<input type="password" name="Repeat-PassWord" class="input-string" />
							</td>
						</tr>
					</table>
				</div>
